                                ...
                                <form class="form-stl" action="{{ route('register') }}" name="frm-login"
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <input type="text" id="frm-reg-lname" name="name"
                                            placeholder="Your name*":value="name" required autofocus
                                            autocomplete="name">
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <input type="text" id="frm-reg-specialite" name="specialite"
                                            placeholder="specialite" :value="specialite">
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                        <label for="frm-reg-date">date integration*</label>
                                        <br>
                                        <input type="date" id="frm-reg-date" name="date"
                                            placeholder="date integration" :value="date">
                                    </fieldset>
